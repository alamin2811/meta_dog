        ...
        <div className='start-playing-section'>
            ...
            <div className="container">
                <div className="start-playing-content">
                    <h2 className='uppercase'>Stop Scrolling Start Playing</h2>
                    ...
                    <div className="start-playing-btns">
                        <button className='play-btn playing-btn'>play Now</button>
                        <button className='buy-btn playing-btn'>Buy Metadog</button>
                    </div>
                </div>
            </div>
        </div>
